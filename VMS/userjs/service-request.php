      ...
      <div class="container">
        ...
        <form id="service-request-form" class="form" action="databaseconnect/rq_insert.php" method="POST" >
          ...
          <div class="form-group">
            ...
            <input type="text" id="vehicle-number" name="vehicle-number" placeholder="Enter your vehicle number" >
            <div id="vehicleNumberError" class="error-message"></div>
          </div>
          ...
          <div class="form-group">
            ...
            <div id="serviceTypeError" class="error-message"></div>
          </div>
